...
def plot_valid_true_vs_pred_by_index(y_valid, y_pred):
    ...
    plt.scatter(x_idx, y_pred,  s=14, alpha=0.7, label="Predicted (y_pred)", marker='x')

    plt.xlabel("Sample index")
    plt.ylabel("LOGG")
    plt.title("Validation Set: True vs Predicted LOGG")
...
plot_valid_true_vs_pred_by_index(y_valid, pred_valid)
